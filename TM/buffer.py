...
from core.utils import get_dataset, get_network, get_daparam, TensorDataset, epoch, ParamDiffAug, set_seed, save_and_print,get_time
...
def main(args):
    ...
    for it in range(0, args.num_experts):
        ...
        for e in range(args.train_epochs):
            ...
            save_and_print(args.log_path, "[{}] Itr: {}\tEpoch: {}\tTrain Acc: {}\tTest Acc: {}".format(get_time(),it, e, train_acc, test_acc))
