...
dim=4
layers_v="v6"
TAG="layers=${layers_v}_arm=${arm}_dim=${dim}_stage2_50_20_v2"
zca=False
lr_it=100
res=128
ldb_it=2000
save_path="/data1/home/ypliu/DSproject/final_dc_result_0226/${dst}/${subset}/${ipc}"
pool_init="/data1/home/ypliu/DSproject/final_dc_result_0226/ImageNet/imagewoof/96/ImageNet_imagewoof_96ipc_ConvNetD5_DC_DC_pool_1_500_5_0.001_100_1500_128_zca_False_#layers=v6_arm=32_dim=4_stage2_50_20/20250227_092626_ImageNet_ConvNetD5_96_210_dc_pool.pt"
method="DC"
