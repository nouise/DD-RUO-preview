...
pool_init="/data2/home/ypliu/DSproject/tm_result/ImageNet/imagefruit/102/ImageNet_imagefruit_102ipc_ConvNetD5_TM_pool_1_7000_0.1_0.001_1000_150_128_zca_False_#new0216_slice200_layers=v5_syn40_arm=32_dim=4_stage2/pool_5000.pt"

TAG="layers=${layers_v}_syn40_arm=${arm}_dim=${dim}_stage2_from13000"
zca=False
lr_it=1000
res=128
ldb_it=150
