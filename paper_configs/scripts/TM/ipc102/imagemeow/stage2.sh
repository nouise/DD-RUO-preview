...
pool_init="/data2/home/ypliu/DSproject/tm_result/ImageNet/imagemeow/102/ImageNet_imagemeow_102ipc_ConvNetD5_TM_pool_1_8000_0.1_0.001_1000_10_128_zca_False_#layers=v5_syn40_arm=32_dim=4_stage1_origin/pool_best.pt"

TAG="layers=${layers_v}_syn40_arm=${arm}_dim=${dim}_stage2_from8000"
zca=False
lr_it=1000
res=128
ldb_it=150
