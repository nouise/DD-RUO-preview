...
pool_init="/data2/home/ypliu/DSproject/tm_result/ImageNet/imagemeow/15/ImageNet_imagemeow_15ipc_ConvNetD5_TM_pool_1_8000_0.1_0.001_1000_10_128_zca_False_#layers=v3-4_syn20_arm=16_dim=2_stage1_from0.1/pool_5000.pt"
TAG="layers=${layers_v}_syn20_arm=${arm}_dim=${dim}_stage2"
zca=False
lr_it=1000
res=128
ldb_it=120
