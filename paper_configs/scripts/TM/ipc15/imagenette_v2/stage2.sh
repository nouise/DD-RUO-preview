...
pool_init="/data2/home/ypliu/DSproject/tm_result/ImageNet/imagenette/15/ImageNet_imagenette_15ipc_ConvNetD5_TM_pool_1_8000_0.1_0.001_1000_10_128_zca_False_#layers=v3-4_syn20_arm=16_dim=2_stage1_from0.1/pool_4000.pt"


TAG="layers=${layers_v}_syn20_arm=${arm}_dim=${dim}_stage1_from0.1"
zca=False
lr_it=1000
res=128
ldb_it=150
