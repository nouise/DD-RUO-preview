...
from core.ts.core.quantizer import (POSSIBLE_QUANTIZATION_NOISE_TYPE,  POSSIBLE_QUANTIZER_TYPE,)
...
class PresetC3x(Preset):
    def __init__(self, start_lr: float = 1e-2, n_itr_per_phase: int = 50000):
